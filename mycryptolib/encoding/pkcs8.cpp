...
MyCryptoLib::PKCS8::PKCS8(const std::string &filename) : PKCSBase("", "")
{
...
MyCryptoLib::PKCS8::PKCS8(const std::string &keyAlgorithm, const std::map<int, std::vector<uint8_t>> &data) :
