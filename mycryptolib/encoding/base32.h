...
{
public:
    static std::string b32Encode(const std::string &data)
    {
        return Base32::b32Encode(std::vector<uint8_t>(data.begin(), data.end()));
    }

    static std::string b32Encode(const std::vector<uint8_t> &data)
    {
        std::string result;
    ...
    static std::vector<uint8_t> b32Decode(const std::string &data)
    {
