...
MyCryptoLib::PKCS12::PKCS12(const std::string &keyAlgorithm, const std::map<int, std::vector<uint8_t> > &data) : IPKCS(), keyAlgorithm(keyAlgorithm)
{
    this->pkcsData = data;
}

MyCryptoLib::PKCS12::PKCS12(const std::string &filename) : IPKCS()
{
