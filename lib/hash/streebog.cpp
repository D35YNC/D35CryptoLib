...
void D35Crypto::Streebog::update(const std::string &data)
{
    this->update(std::vector<uint8_t>(data.begin(), data.end()));
}

void D35Crypto::Streebog::update(const std::vector<uint8_t> &data)
{
...
void D35Crypto::Streebog::update(std::ifstream &file)
{
    if (!file.is_open())
    {
...
void D35Crypto::Streebog::_pad(std::vector<uint8_t> &buffer)
{
    if (buffer.size() < 64)
    {
...
void D35Crypto::Streebog::_finalize(std::vector<uint8_t> &buffer)
{
...
std::vector<uint8_t> D35Crypto::Streebog::_xor512(const std::vector<uint8_t> &a, const std::vector<uint8_t> &b)
{
    std::vector<uint8_t> result(64, 0x00);
    for (int i = 0; i < 64; i++)
    {
...
std::vector<uint8_t> D35Crypto::Streebog::_getIterKey(const std::vector<uint8_t> &k, int i)
{
    std::vector<uint8_t> result(64, 0x00);
...
std::vector<uint8_t> D35Crypto::Streebog::_lpsTransform(const std::vector<uint8_t> &state)
{
    // S
...
std::vector<uint8_t> D35Crypto::Streebog::_eTranform(const std::vector<uint8_t> &k, const std::vector<uint8_t> &m)
{
...
std::vector<uint8_t> D35Crypto::Streebog::_compress(const std::vector<uint8_t> &N, const std::vector<uint8_t> &h, const std::vector<uint8_t> &m)
{
