...
private:
    ...
    void _init();
    void _pad(std::vector<uint8_t>&);
    void _updateState(std::vector<uint8_t>&);
    void _finalize(std::vector<uint8_t>&);

    std::vector<uint8_t> _xor512(const std::vector<uint8_t>&, const std::vector<uint8_t>&);
    std::vector<uint8_t> _add512(const std::vector<uint8_t>&, const std::vector<uint8_t>&);
    std::vector<uint8_t> _getIterKey(const std::vector<uint8_t>&, int);
    std::vector<uint8_t> _lpsTransform(const std::vector<uint8_t>&);
    std::vector<uint8_t> _eTranform(const std::vector<uint8_t>&, const std::vector<uint8_t>&);
    std::vector<uint8_t> _compress(const std::vector<uint8_t>&, const std::vector<uint8_t>&, const std::vector<uint8_t>&);
    ...
    const uint8_t tau[64] = { 0 , 8 , 16, 24, 32, 40, 48, 56, 1 , 9 , 17, 25, 33, 41, 49, 57, 2 , 10, 18, 26, 34, 42,
