...
private:
    ...
    void _processBlock(std::vector<uint32_t>);

    static uint32_t Sigma0(uint32_t);
    static uint32_t Sigma1(uint32_t);
    static uint32_t SIGMA0(uint32_t);
    static uint32_t SIGMA1(uint32_t);
    static uint32_t rotr(uint32_t, size_t);
    static uint32_t Ch(uint32_t, uint32_t, uint32_t);
    static uint32_t Maj(uint32_t, uint32_t, uint32_t);

    uint32_t _hashState[8] = { 0x00 };
    const uint32_t CONSTS[64] = { 0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5,
